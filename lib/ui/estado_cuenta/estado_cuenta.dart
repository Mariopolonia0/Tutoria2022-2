...
class _EstadoCuentaState extends State<EstadoCuenta> {
    ...
    return Row(
      ...
      children: [
        Column(
          ...
          children: [
            ...
            (estadoDto.transaccion >= 0.0)
                ? texto(
                    formatearMonto(estadoDto.transaccion),
        ...
        Column(
          ...
          children: [
            texto(
              formatoFecha(estadoDto.fechaRealizado),
            ),
            texto(
              formatearMonto(estadoDto.estado),
            )
          ],
        ),
      ],
  ...
  octenerMaterias() async {
    ...
    client.getEstados(arguments.estudianteId.toString()).then(
      (value) {
        _estados = value;
        setState(
          () {
